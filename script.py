...
data = pd.read_csv("variables_seleccionadas.csv")


grupo_si_no = ['s101p11','s101p12a','s101p12b','s101p12c','s101p12d','s101p12e', 's101p61', 's101p62', 's101p63',
               's101p64', 's101p65', 's101p66', 's101p67', 's101p68', 's101p71', 's101p72', 's101p73', 's101p74', 's101p75', 's101p76',
               's101p77', 's101p141', 's101p142', 's101p143', 's101p144']
grupo_cantidad = ['s101p3a', 's101p3b', 's101p4a', 's101p4b', 's101p4b1']
grupo_likert = ['s101p13', 's101p171', 's101p172', 's101p173', 's101p174', 's101p175', 's101p176', 's101p181', 's101p182', 's101p183']
...
for columna in data:
    ...
    for i in range(max_i):
        ...
        if(columna in grupo_si_no):
            ...
            table[columna].append(data[columna][i])   

table = pd.DataFrame(table)
table.to_csv('datos_sin_normalizar.csv', header=True, index=False)
